...
- Ensure that you have an active [Loopring account](https://loopring.io/#/trade/lite/LRC-ETH). 
    - For full functionality, use a GameStop or MetaMask wallet. While the Loopring wallet will work, please note that airdrops are currently not supported.
...
| privateKey   | LoopringPrivateKey   |
    ...
    ### Validate
    - To make sure the setup is successful, double click on Maize.exe in the `Maize` folder to launch the application.
