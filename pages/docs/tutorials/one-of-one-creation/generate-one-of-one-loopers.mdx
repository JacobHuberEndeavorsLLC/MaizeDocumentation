...
- Individual sprite sheets. Templates and more: [here](https://www.cobmin.com/posts/Bring-Pixel-Art-to-Life)
- Maize Software: Make sure it's [downloaded](../download-maize) and [setup](../setup-maize) correctly.
- Owning [Maize Premium Access](https://loopexchange.art/collection/maize-access/item/0x6692d7a147762ce9335746c7b062576ef9834500f5546a29c724c55752f668c7)
...
If your NFTs are already minted then click the `NFTs already Created` button.

- Upon selection, a CSV template will be provided for you to fill out. This template requires specific details about each NFT for which you wish to generate sprites. You can easily retrieve this information by utilizing the [NFT Info From Collection](../lookups/nft-info-from-collection) feature.

The CSV template will include the following columns:

| Field | Description | Example |
|----------|----------|----------|
| name | The base name of your NFT | regen #1 |
| nftId | The unique identifier for the NFT | 0x0c4f9...7c14f |
| nftCid | The Content Identifier (CID) for the NFT's image | QmNrnz...mrKNMA |
| properties | Attributes derived from the NFT's metadata | `{"background":"#bde0fe","bones":"fine silver", ...}` |

Please ensure all fields are accurately filled to facilitate the sprite generation process.

- Save and close the CSV file. 

- Choose the LooperLand's Item you are creating and populate the Project Name, Collection Address, Royalty Percentage, and Input Directory. The chart below provides additional information on each. 

| Field | Description | Example |
|----------|----------|----------|
| Project Name | LooperLand's Project Name | Cobs Farm |
| Collection Address | Blockchain Address for the collection | 0xa6a1de23cfe7a2cbd9d3c63d53efd263426bc8ed |
| Royalty Percentage | Percentage of royalties on sales (1-10%) | 5 |
| Input Directory | Sprite's folder location | C:\cobmin\LL_Ready |
...
- This will create all sprites from the provided NFTs. Find the ReadMeForNextSteps.txt and follow the instructions.
