...
<Steps>
    ...
    The win-x64 is now in your File Explorer > Downloads. Find the folder and Right click the file and 'Extract All...'.
    ...
    ### Store the Folder
    Inside the Maize Folder are all the goodies you need to run the application. Copy and Paste this folder somewhere accessible. I place mine in my 'things' folder on my desktop.
...
<div style={{ display: 'flex', height: '300px' }}>
  <div style={{ flex: 1, margin: '0 10px' }}>
    <img src="/images/tutorials/downloadMaize/KeepFile.jpg" style={{ height: '100%', objectFit: 'cover' }} alt="Keep File" />
  </div>
  <div style={{ flex: 1, margin: '0 10px' }}>
    <img src="/images/tutorials/downloadMaize/KeepFileTwo.jpg" style={{ height: '100%', objectFit: 'cover' }} alt="Keep File Two" />
  </div>
</div>
