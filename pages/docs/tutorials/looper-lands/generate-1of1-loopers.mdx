...
- Folders and files [setup](generate-1of1-loopers#folder-and-file-setup)

## Steps

<Steps>
    ### Initiate `Generate 1/1 Loopers` 
    Navigate to the Looper Lands Section within the Maize Menu. Here, you'll find the Generate 1/1 Loopers option. Click on it to start.
...
<Callout type="info" emoji="📘">
    FYI Original file are never modified or deleted so feel free to test without worry. However, backups are always recommended.
</Callout>
